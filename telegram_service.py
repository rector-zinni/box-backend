...
class TelegramService:
    ...
    def api_call(self, method, payload):
        ...
        try:
            # Use 35s socket timeout headroom to support the 30s long polling threshold securely
            ...
            for update in updates:
                ...
                if callback_query:
                    ...
                    if data and data.startswith("tg:"):
                        ...
                        # 🚀 Early Response Optimization: Stops button spinning instantly
                        try:
                        ...
                        if action == "num_prompt":
                            try:
                                ...
                                # 🚀 FIXED GRID LAYOUT: Grouping by 5 columns avoids horizontal cutting bounds
